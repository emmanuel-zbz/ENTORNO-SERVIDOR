...
<body>
	...
	<div id="contenedora" style="float:none; margin: 0 auto;width: 900px;" >
		...
		<div class="clearfix">
			...
			<div style="float: left;width: 15%">Numero de productos</div>
	...
	<% 
        if (request.getAttribute("listaFabricantesDTO") != null) {
            List<FabricanteDTO> listaFabricantesDTO = (List<FabricanteDTO>)request.getAttribute("listaFabricantesDTO");
            
            for (FabricanteDTO fabricanteDTO : listaFabricantesDTO) {
    %>

		<div style="margin-top: 6px;" class="clearfix">
			<div style="float: left;width: 15%"><%= fabricanteDTO.getIdFabricante()%></div>
			<div style="float: left;width: 30%"><%= fabricanteDTO.getNombre()%></div>
			<div style="float: left;width: 15%"><%= fabricanteDTO.getCountProductos()%></div>
	...
	<% 
        ...
        <div>
            <form action="${pageContext.request.contextPath}/tienda/fabricantes/" style="display: inline;">
                <label for="OrdenarPor">Ordenar por:</label>
                <select name="ordenar-por" id="ordenarPor">
                    <option value="nombre">nombre</option>
                    <option value="codigo">Codigo Fabricante</option>
                </select>
                <label for="modo">Modo:</label>
                    <select name="modo-ordenar" id="modo">
